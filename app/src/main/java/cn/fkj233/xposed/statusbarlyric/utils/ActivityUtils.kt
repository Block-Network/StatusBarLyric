...
import cn.fkj233.xposed.statusbarlyric.utils.HttpUtils.Get
...
object ActivityUtils {
    ...
    fun cleanConfig(activity: Activity) {
        activity.getSharedPreferences("cn.fkj233.xposed.statusbarlyric_preferences", 0).edit().clear().apply()
        val packageManager: PackageManager = activity.packageManager
        packageManager.setComponentEnabledSetting(
            ComponentName(activity, "cn.fkj233.xposed.statusbarlyric.launcher"),
