...
class MainPage : BasePage() {
    override fun onCreate() {
        ...
        TextSummaryArrow(TextSummaryV(textId = R.string.CustomLyric, onClickListener = { showFragment("custom") }))
        TextSummaryArrow(TextSummaryV(textId = R.string.CustomIcon, onClickListener = { showFragment("IconCustom") }))
