...
class Config {
    ...
    fun gerIconList(): Array<String> {
        return arrayOf("Netease", "KuGou", "KuGouLite", "KuWo", "QQMusic", "Myplayer", "MiGu", "MiPlayer", "RPlayer", "Default")
    }
    ...
    private var rPlayer: String
        get() = config.optString("RPlayer", RPlayer)
        set(str) = config.put("RPlayer", str)
