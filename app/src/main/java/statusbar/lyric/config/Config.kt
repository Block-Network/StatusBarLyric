...
class Config {
    ...
    fun getDefaultIconList(): List<String> = listOf("Netease", "KuGou", "KuGouLite", "KuWo", "QQMusic", "Myplayer", "MiGu", "MiPlayer", "APM", "Default")

    fun gerIconList(): HashSet<String> {
        val data = hashSetOf("Netease", "KuGou", "KuGouLite", "KuWo", "QQMusic", "Myplayer", "MiGu", "MiPlayer", "APM", "Default")
